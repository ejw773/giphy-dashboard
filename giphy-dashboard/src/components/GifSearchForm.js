                        ...
                        <div className="row">
                            ...
                            <div className="col-sm-10">
                                <div className="form-check">
                                    <input className="form-check-input" type="radio" name="searchLimit" id="searchLimit5" value={this.state.searchLimit} />
                                    <label className="form-check-label" htmlFor="searchLimit5">5</label>
                                </div>
                                <div className="form-check">
                                    <input className="form-check-input" type="radio" name="searchLimit" id="searchLimit20" value={this.state.searchLimit} />
                                    <label className="form-check-label" htmlFor="searchLimit20">20</label>
                                </div>
                                <div className="form-check">
                                    <input className="form-check-input" type="radio" name="searchLimit" id="searchLimit50" value={this.state.searchLimit} />
